/*
 ...
 Source Schema         : attendance_management

 Target Server Type    : MySQL
 Target Server Version : 50736
 File Encoding         : 65001

 Date: 06/03/2022 14:16:39
*/
...
-- ----------------------------
-- Table structure for school_attendance
-- ----------------------------
...
CREATE TABLE `school_attendance` (
  ...
  `teacher_user_id` bigint(20) DEFAULT NULL COMMENT '老师ID',
  `course_id` bigint(20) DEFAULT NULL COMMENT '课程ID',
  `course_name` varchar(255) DEFAULT NULL COMMENT '课程名称',
  `course_start` datetime DEFAULT NULL COMMENT '课程开始时间',
  `course_end` datetime DEFAULT NULL COMMENT '课程结束时间',
  `total_number` int(32) DEFAULT NULL COMMENT '总人数',
  `sign_in` int(32) DEFAULT NULL COMMENT '已签到人数',
  `no_sign_in` int(32) DEFAULT NULL COMMENT '未签到人数',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`attendance_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='考勤表';

-- ----------------------------
-- Table structure for school_attendance_detail
-- ----------------------------
DROP TABLE IF EXISTS `school_attendance_detail`;
CREATE TABLE `school_attendance_detail` (
  `attendance_id` bigint(20) DEFAULT NULL COMMENT '考勤ID',
  `user_id` bigint(20) DEFAULT NULL COMMENT '学生ID',
  `status` varchar(20) DEFAULT NULL COMMENT '考勤状态',
  `is_late` varchar(20) DEFAULT NULL COMMENT '是否迟到',
  `sign_time` datetime DEFAULT NULL COMMENT '考勤时间',
  `sign_type` varchar(20) DEFAULT NULL COMMENT '考勤类型',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间'
...
CREATE TABLE `school_class` (
  ...
  `teacher_user_id` bigint(20) DEFAULT NULL COMMENT '授课老师ID',
...
-- ----------------------------
-- Table structure for school_class_user
-- ----------------------------
...
CREATE TABLE `school_college` (
  `college_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '院系ID',
  `college_name` varchar(50) NOT NULL COMMENT '院系名称',
  `create_by` varchar(64) DEFAULT '' COMMENT '创建者',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) DEFAULT '' COMMENT '更新者',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='院系信息表';

-- ----------------------------
-- Table structure for school_college_major
-- ----------------------------
DROP TABLE IF EXISTS `school_college_major`;
CREATE TABLE `school_college_major` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='院系专业关联表';
...
-- ----------------------------
-- Table structure for school_course_major
-- ----------------------------
DROP TABLE IF EXISTS `school_course_major`;
CREATE TABLE `school_course_major` (
  `course_id` bigint(20) NOT NULL COMMENT '课程ID',
  `major_id` bigint(20) NOT NULL COMMENT '专业ID',
  PRIMARY KEY (`course_id`,`major_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='课程专业关联表';

-- ----------------------------
-- Table structure for school_leave
-- ----------------------------
DROP TABLE IF EXISTS `school_leave`;
CREATE TABLE `school_leave` (
  `leave_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '请假ID',
  `user_id` bigint(20) DEFAULT NULL COMMENT '学生ID',
  `user_name` varchar(50) DEFAULT NULL COMMENT '学生名称',
  `leave_text` varchar(255) DEFAULT NULL COMMENT '请假内容',
  `teacher_user_id` bigint(20) DEFAULT NULL COMMENT '辅导员ID',
  `teacher_use_name` varchar(255) DEFAULT NULL COMMENT '辅导员名称',
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='请假信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='专业信息表';
...
CREATE TABLE `sys_logininfor` (
  ...
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB AUTO_INCREMENT=112 DEFAULT CHARSET=utf8 COMMENT='系统访问记录';
