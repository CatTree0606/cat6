...
import com.CatTree.system.service.ISysUserFaceService;
...
public class SysProfileController extends BaseController {
    ...
    public AjaxResult profile() {
        ...
        if (!CollectionUtils.isEmpty(sysUserFaces)) {
            ...
            ajax.put("sysUserFaces", sysUserFaces.get(0));
        } else {
            ajax.put("sysUserFaces", new SysUserFace());
        }
        return ajax;
    }
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws IOException {
        if (!file.isEmpty()) {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(CatTreeConfig.getAvatarPath(), file);
